...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (_mode == KKPasscodeModeSet) {
        self.navigationItem.title = KKPasscodeLockLocalizedString(@"设置密码", @"");
...
//                                                                                              action:@selector( )];
        ...
        self.navigationItem.title = KKPasscodeLockLocalizedString(@"更改密码", @"");
        UIBarButtonItem*backButton = [[UIBarButtonItem alloc] initWithTitle:@"返回 "
                                                                      style:UIBarButtonItemStyleBordered
                                                                     target:self
                                                                     action:@selector(cancelButtonPressed:)];
        ...
        self.navigationItem.title = KKPasscodeLockLocalizedString(@"关闭密码", @"");
        UIBarButtonItem*backButton = [[UIBarButtonItem alloc] initWithTitle:@"返回 "
                                                                      style:UIBarButtonItemStyleBordered
                                                                     target:self
                                                                     action:@selector(cancelButtonPressed:)];
        ...
        self.navigationItem.title = KKPasscodeLockLocalizedString(@"输入密码", @"");
    }
		...
		if (_mode == KKPasscodeModeSet) {
			if ([textField isEqual:_setPasscodeTextField]) {
				...
				if (![_confirmPasscodeTextField.text isEqualToString:_setPasscodeTextField.text]) {
					...
					_passcodeConfirmationWarningLabel.text = KKPasscodeLockLocalizedString(@"密码错误，再试一次.", @"");
					[self moveToPreviousTableView];
				} else {
			...
			if ([textField isEqual:_enterPasscodeTextField]) {
				...
				if ([passcode isEqualToString:_setPasscodeTextField.text]) {
					_setPasscodeTextField.text = @"";
					_passcodeConfirmationWarningLabel.text = KKPasscodeLockLocalizedString(@"输入一个不同的密码.", @"");
...
- (UIView*)headerViewForTextField:(UITextField*)textField
{
    ...
    if (_mode == KKPasscodeModeSet) {
        if ([textField isEqual:_enterPasscodeTextField]) {
            headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的密码", @"");
        } else if ([textField isEqual:_setPasscodeTextField]) {
            headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的密码", @"");
        } else if ([textField isEqual:_confirmPasscodeTextField]) {
            headerLabel.text = KKPasscodeLockLocalizedString(@"再次输入你的密码", @"");
        }
    } else if (_mode == KKPasscodeModeDisabled) {
        headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的密码", @"");
    } else if (_mode == KKPasscodeModeChange) {
        if ([textField isEqual:_enterPasscodeTextField]) {
            headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的旧密码", @"");
        } else if ([textField isEqual:_setPasscodeTextField]) {
            headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的新密码", @"");
        } else {
            headerLabel.text = KKPasscodeLockLocalizedString(@"再次输入你的新密码", @"");
        }
    } else {
        headerLabel.text = KKPasscodeLockLocalizedString(@"输入你的密码", @"");
    }
